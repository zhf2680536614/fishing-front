 ...
 * @returns {Promise}
 */
export const uploadSpotImage = (file) => {
  const formData = new FormData()
  formData.append('file', file)
  return request.post('/file/upload/spot', formData, {
    headers: {
      'Content-Type': 'multipart/form-data'
    }
  })
 ...
 * @returns {Promise}
 */
export const uploadSpotImages = (files) => {
  const formData = new FormData()
  files.forEach(file => {
    formData.append('files', file)
  })
  return request.post('/file/upload/spot/batch', formData, {
    headers: {
      'Content-Type': 'multipart/form-data'
    }
  })
...
export const uploadImage = (formData) => {
  return request.post('/file/upload/gear', formData, {
    headers: {
      'Content-Type': 'multipart/form-data'
    }
  })
